		...
		*/
		function addTouchHandler(){
			if(isTouchDevice || isTouch){
				...
				$(options.sectionSelector).off('touchstart ' +  MSPointer.down).on('touchstart ' + MSPointer.down, touchStartHandler);
				$(options.sectionSelector).off('touchmove ' + MSPointer.move).on('touchmove ' + MSPointer.move, touchMoveHandler);
			}
		}
		...
		*/
		function removeTouchHandler(){
			if(isTouchDevice || isTouch){
				...
				$(options.sectionSelector).off('touchstart ' + MSPointer.down);
				$(options.sectionSelector).off('touchmove ' + MSPointer.move);
			}
		}
