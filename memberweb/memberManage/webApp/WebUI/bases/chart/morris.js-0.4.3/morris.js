  ...
  Morris.Donut = (function(_super) {
    ...
    function Donut(options) {
      ...
      this.values = (function() {
        var _i, _len, _ref, _results, tmpVal;
        _ref = this.data;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          row = _ref[_i];
          tmpVal = parseFloat(row.value);
          if (tmpVal != 0)
              this.isTotallyZero = false;
          _results.push(tmpVal);
        }

        if (this.isTotallyZero){
            _results = [];
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                _results.push(-1);
            }
    ...
    Donut.prototype.redraw = function() {
      ...
      for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
       ...
       var fontSize1 =   (!!this.options.text1 && !!this.options.text1.fontSize && this.options.text1.fontSize >0)?  this.options.text1.fontSize : 15;
        var fontWeight1 =   (!!this.options.text1 && !!this.options.text1.fontWeight && this.options.text1.fontWeight >0)?  this.options.text1.fontWeight : 800;

        var fontSize2 =   (!!this.options.text2 && !!this.options.text2.fontSize && this.options.text2.fontSize >0)?  this.options.text2.fontSize : 14;
        var fontWeight2 =   (!!this.options.text2 && !!this.options.text2.fontWeight && this.options.text2.fontWeight >0)?  this.options.text2.fontWeight : 200;

      this.text1 = this.drawEmptyDonutLabel(cx, cy - 10, this.options.labelColor,  fontSize1, fontWeight1);
      this.text2 = this.drawEmptyDonutLabel(cx, cy + 10, this.options.labelColor, fontSize2, fontWeight2);
