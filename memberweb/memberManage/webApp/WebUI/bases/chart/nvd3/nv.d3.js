...
nv.utils.calcApproxTextWidth = function (svgTextElem) {
    if (typeof svgTextElem.style === 'function'
        ...
        var constant_factor =  (textLength > 6)? 0.5 : 0.8;
        constant_factor =  (textLength > 15)? 0.3 : constant_factor;

        return textLength * fontSize * constant_factor;
    }
    return 0;
};
...
nv.models.multiBarChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      if (showControls) {
        var controlsData = [
          { key: lang.t_grouped, disabled: multibar.stacked() },
          { key: lang.t_stacked, disabled: !multibar.stacked() }
        ];
...
nv.models.multiBarHorizontalChart = function() {
  ...
  var showTooltip = function(e, offsetElement) {
    var left = e.e.pageX + ( offsetElement.offsetLeft || 0 ),
        top = e.e.pageY + ( offsetElement.offsetTop || 0),
        x = xAxis.tickFormat()(multibar.x()(e.point, e.pointIndex)),
        y = yAxis.tickFormat()(multibar.y()(e.point, e.pointIndex)),
        content = tooltip(e.series.key, x, y, e, chart);
